...
const STAT_KEYS = ["about.stat1", "about.stat2", "about.stat3"] as const;
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-12 overflow-hidden rounded-2xl border border-border bg-muted/40 md:mt-16">
              <div className="grid grid-cols-1 divide-y divide-border sm:grid-cols-3 sm:divide-x sm:divide-y-0">
                {STAT_KEYS.map((key) => (
                  <div key={key} className="px-6 py-8 text-center">
                    <div className="text-4xl font-bold tracking-tight text-foreground">
                      {t(`${key}.value`)}
                    </div>
                    <p className="mt-2 text-sm text-muted-foreground">{t(`${key}.label`)}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="border-t border-border px-4 py-16 sm:px-6 md:py-24">
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-x-16 gap-y-10 md:grid-cols-2">
            <div>
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">{t("about.why.h2")}</h2>
              <p className="mt-5 text-[15px] leading-7 text-muted-foreground">{t("about.why.p")}</p>
            </div>
            <div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-12 grid grid-cols-1 gap-10 md:grid-cols-3">
              <div className="md:col-span-1">
                ...
                <p className="text-sm font-medium text-primary">{t("about.author.role")}</p>
                <p className="mt-4 text-[15px] leading-7 text-muted-foreground">
                  {t("about.author.bio")}{" "}
                ...
                <div className="mt-5 flex flex-wrap items-center gap-4 text-sm">
                  ...
                  <a
                    ...
                    aria-label={t("about.author.emailAria")}
              ...
              <div className="rounded-2xl border border-border bg-muted/30 p-8 md:col-span-2">
                <h3 className="text-xl font-semibold">{t("about.work.h3")}</h3>
                <p className="mt-4 text-[15px] leading-7 text-muted-foreground">
                  {t("about.work.p1")}
                </p>
                <p className="mt-4 text-[15px] leading-7 text-muted-foreground">
